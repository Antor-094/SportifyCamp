...
const Banner = () => {
  ...
  return (
    <div className="relative">
      <Slider {...settings} ref={sliderRef}>
        <div className='relative h-[90vh]'>
          ...
          <div className='absolute inset-0 flex flex-col justify-center items-center text-white'>
            <h3 className='text-4xl font-bold mb-4 text-center'>Learn new skills and make new friends</h3>
        ...
        <div className='relative h-[90vh]'>
          ...
          <div className='absolute inset-0 flex flex-col justify-center items-center text-white'>
            <h3 className='text-4xl font-bold text-center mb-4'>Get fit and have fun</h3>
        ...
        <div className='relative h-[90vh]'>
          ...
          <div className='absolute inset-0 flex flex-col justify-center items-center text-white'>
            <h3 className='text-4xl font-bold text-center mb-4'>Experience the thrill of competition</h3>
        ...
        <div className='relative h-[90vh]'>
          ...
          <div className='absolute inset-0 flex flex-col justify-center items-center text-white'>
            <h3 className='text-4xl font-bold text-center mb-4'>Discover your passion for sports</h3>
        ...
        <div className='relative h-[90vh]'>
          ...
          <div className='absolute inset-0 flex flex-col justify-center items-center text-white'>
            <h3 className='text-4xl font-bold text-center mb-4'>Experience the great outdoors</h3>
        ...
        <div className='relative h-[90vh]'>
          ...
          <div className='absolute inset-0 flex flex-col justify-center items-center text-white'>
            <h3 className='text-4xl font-bold text-center mb-4'>Build confidence and self-esteem</h3>
      ...
      <button className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-white text-black py-2 px-4 rounded-full font-bold text-lg hover:bg-gray-200 transition-colors duration-300" onClick={handlePrevClick}>
       <FaAngleLeft></FaAngleLeft>
      </button>
      <button className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-white text-black py-2 px-4 rounded-full font-bold text-lg hover:bg-gray-200 transition-colors duration-300" onClick={handleNextClick}>
